          ...
          <div className="flex flex-col justify-center items-center mt-6">
            ...
            <div className="w-full mx-4 p-5">
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  <span
                    className={`text-primary-900 text-subtitle-16 ${
                      selectedType === "regular-time" ? "text-white" : ""
                    }`}
                  >
                    에그클럽
                  </span>
                  <span
                    className={`text-primary-900 text-body-14 ${selectedType === "regular-time" ? "text-white" : ""}`}
                  >
                    지속형 모임으로 계속해서 만나요
                    <br />
                    모임장의 승인이 필요해요

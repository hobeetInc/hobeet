          ...
          <div className="w-[358px] h-[88px] justify-start items-center gap-2 inline-flex mt-2">
            ...
            <div className="w-[248px] py-0.5 flex-col justify-start items-start gap-0.5 inline-flex">
              ...
              <div className="pt-[3px] justify-start items-center gap-2 inline-flex">
                ...
                <Text variant="body_medium-14" className="text-gray-400">
                  {customDate(oneTimeClub.egg_pop.egg_pop_date_time).date}
                </Text>
                <Text variant="body_medium-14" className="text-gray-400">
                  {customDate(oneTimeClub.egg_pop.egg_pop_date_time).time}
                </Text>
              </div>
            </div>
          </div>
...
{data?.map((oneTimeClub) => (
  <Link
    href={`/club/one-time-club-sub/${oneTimeClub.egg_pop.egg_pop_id}`}
    key={oneTimeClub.egg_pop.egg_pop_id}
  >
    <div key={oneTimeClub.egg_pop.egg_pop_id} className="oneTimeClub-card my-4 mb-[64px]">
      ...
      <div className="h-[88px] justify-start items-center gap-2 inline-flex">
        ...
        <div>
          ...
          <h3 className="text-sm font-semibold mt-2">{oneTimeClub.egg_pop.egg_pop_name}</h3>
          <div className="flex items-center mt-1 text-gray-400 text-sm">
            <span>
              <Image src={"/asset/Icon/Icon-Location.png"} alt="지도" width={16} height={16} />
            </span>
            <span className="ml-1">{customAddress(oneTimeClub.egg_pop.egg_pop_location)}</span>
            <span className="ml-2">{customDate(oneTimeClub.egg_pop.egg_pop_date_time)}</span>
          </div>
        </div>
      </div>
    </div>

...
export const ApproveMemberTabBar: React.FC<TabBarProps> = ({ activeTab, onTabChange, vlaue }) => {
  ...
  return (
    <div className="w-[390px] px-4 pt-2.5 border-b border-gray-50 flex">
      <button className="w-[179px] text-base font-medium font-pretendard relative" onClick={() => onTabChange(true)}>
        <span
      ...
      <button className="w-[179px] text-base font-medium font-pretendard relative" onClick={() => onTabChange(false)}>
        <span
          className={`text-center text-base font-pretendard relative ${
